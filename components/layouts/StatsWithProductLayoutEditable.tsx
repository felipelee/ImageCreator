...
interface StatsWithProductLayoutEditableProps {
  brand: Brand
  sku: SKU
  isEditMode?: boolean
...
export function StatsWithProductLayoutEditable({ 
  brand, 
  sku,
  isEditMode = false,
  ...
  onSizeChange = () => {},
  onRotationChange = () => {}
}: StatsWithProductLayoutEditableProps) {
  ...
  return (
    ...
    >
      ...
      {/* Stat 1 Value - Editable */}
      <p
        {...getEditableProps('stat1Value')}
        style={{
          position: 'absolute',
          ...
          ...((getEditableProps('stat1Value') as any).style || {})
        }}
      >
        {sku.copy.statsWithProduct?.stat1_value || '90%'}
      </p>

      {/* Stat 1 Label - Editable */}
      <p
        {...getEditableProps('stat1Label')}
        style={{
          position: 'absolute',
          ...
          ...((getEditableProps('stat1Label') as any).style || {})
        }}
      >
        {sku.copy.statsWithProduct?.stat1_label || 'felt more motivated*'}
      </p>

      {/* Stat 2 Value - Editable */}
      <p
        {...getEditableProps('stat2Value')}
        style={{
          position: 'absolute',
          ...
          ...((getEditableProps('stat2Value') as any).style || {})
        }}
      >
        {sku.copy.statsWithProduct?.stat2_value || '84%'}
      </p>

      {/* Stat 2 Label - Editable */}
      <p
        {...getEditableProps('stat2Label')}
        style={{
          position: 'absolute',
          ...
          ...((getEditableProps('stat2Label') as any).style || {})
        }}
      >
        {sku.copy.statsWithProduct?.stat2_label || 'were more likely to start or complete a task*'}
      </p>

      {/* Stat 3 Value - Editable */}
      <p
        {...getEditableProps('stat3Value')}
        style={{
          position: 'absolute',
          ...
          ...((getEditableProps('stat3Value') as any).style || {})
        }}
      >
        {sku.copy.statsWithProduct?.stat3_value || '79%'}
      </p>

      {/* Stat 3 Label - Editable */}
      <p
        {...getEditableProps('stat3Label')}
        style={{
          position: 'absolute',
          ...
          wordBreak: 'break-word',
          overflowWrap: 'break-word',
          ...((getEditableProps('stat3Label') as any).style || {})
        }}
      >
